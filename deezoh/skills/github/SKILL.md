---
name: "github"
description: "Work with GitHub repos: list repos, read files, clone, create issues and PRs"
---

# GitHub

## Purpose
Let Muse read and work with the user's GitHub repositories through the REST API
...
CLIs in `bin/`:
- `gh-api METHOD /path [--data '{...}']` — raw REST calls (GET/POST/PUT/DELETE).
- `gh-put-file OWNER/REPO /local/path repo/path [--message "msg"]` — create or
  update a file in a repo via the contents API; prints the commit SHA.
